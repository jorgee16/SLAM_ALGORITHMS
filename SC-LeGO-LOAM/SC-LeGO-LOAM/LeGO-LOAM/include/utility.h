...
// extern const int groundScanInd = 7; // 7


// Ouster OS0-32 ROS2 BAG
// extern const int N_SCAN = 32;
// extern const int Horizon_SCAN = 1024;
// extern const float ang_res_x = 360.0/float(Horizon_SCAN);
// extern const float ang_res_y = 90/float(N_SCAN-1);
// extern const float ang_bottom = 45+0.01;
// extern const int groundScanInd = 12; // 7


// Ouster OS1-64 TIAGO BERLIM
...
extern const float historyKeyframeFitnessScore = 1.2; // default 0.3; the smaller the better alignment //0.7  // 1.5
